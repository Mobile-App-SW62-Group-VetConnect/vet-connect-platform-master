...
public class VetServiceResourceFromEntityAssembler {
    public static VetServiceResource toResourceFromEntity(VetService entity) {
        return new VetServiceResource(entity.getId(), entity.getVetCenter().getId(), entity.getName(), entity.getDescription(), entity.getPrice(), entity.getDuration(), entity.getCategory(), entity.getFeatures(), entity.getIsActive());
    }
}
